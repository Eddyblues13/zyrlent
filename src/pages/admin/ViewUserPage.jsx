...
import {
    ...
    ArrowUpRight, ArrowDownLeft, Clock, Copy
} from 'lucide-react'
        ...
        <Background>
            <div className="min-h-screen">
                ...
                <div className="flex gap-2 px-4 sm:px-8 py-3 border-b border-white/5 overflow-x-auto no-scrollbar bg-[rgba(8,10,46,0.3)]">
                    ...
                    <Tab active={activeTab === 'orders'} label="Orders" onClick={() => setActiveTab('orders')} />
                        ...
                        <div className="space-y-3">
                            {(user.orders ?? []).length === 0 && (
                                <Card className="p-12 text-center">
                                    <p className="text-sm text-white/30">No orders</p>
                                </Card>
                            )}
                                ...
                                <Card key={order.id} className="p-4">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="text-right flex-shrink-0 ml-3">
                                            ...
                                            <p className="text-[10px] text-white/20 mt-1">{new Date(order.created_at).toLocaleDateString()}</p>
                                        </div>
                                    </div>
                                </Card>
                            ))}
